/*	crontab.c,v 1.7 2012/11/03 17:33:01 christos Exp	*/
...
#else
__RCSID("crontab.c,v 1.7 2012/11/03 17:33:01 christos Exp");
#endif
#endif
...
replace_cmd(void) {
	...
	(void)fprintf(tmp, "# (Cron version %s -- %s)\n", CRON_VERSION, "crontab.c,v 1.7 2012/11/03 17:33:01 christos Exp");
