/*	refclock_oncore.c,v 1.6 2012/02/01 07:46:22 kardel Exp	*/
...
static const char *Month[] = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jly",
	"Aug", "Sep", "Oct", "Nov", "Dec" };
 ...
 */
	...
	FILE	*fd;
	char	*cc, *ca, line[100], units[2], device[64], Msg[160];
	const char *cp;
	const char **cpp, *dirs[] = { "/etc/ntp", "/etc", 0 };
