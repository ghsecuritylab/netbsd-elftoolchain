/* linux_sysent.c,v 1.81 2013/04/08 20:58:24 pooka Exp */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "linux_sysent.c,v 1.81 2013/04/08 20:58:24 pooka Exp");
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	{ 0, 0, 0,
	    (sy_call_t *)linux_sys_gettid },	/* 221 = gettid */
	{ ns(struct linux_sys_tkill_args), 0,
	    (sy_call_t *)linux_sys_tkill },	/* 222 = tkill */
	...
	{ ns(struct linux_sys_set_tid_address_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_set_tid_address },/* 253 = set_tid_address */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 258 = unimplemented timer_ delete */
	...
	{ ns(struct linux_sys_statfs64_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_statfs64 },	/* 263 = statfs64 */
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 277 = unimplemented waitid */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 278 = unimplemented vserver */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 279 = unimplemented add_key */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 280 = unimplemented request_key */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 281 = unimplemented keyctl */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 282 = unimplemented ioprio_set */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 283 = unimplemented ioprio_get */
	{ 0, 0, 0,
	...
	{ ns(struct linux_sys_set_robust_list_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_set_robust_list },/* 304 = set_robust_list */
	{ ns(struct linux_sys_get_robust_list_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_get_robust_list },/* 305 = get_robust_list */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 306 = unimplemented splice */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 307 = unimplemented sync_file_range */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 308 = unimplemented tee */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 309 = unimplemented vmsplice */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 310 = unimplemented move_pages */
	{ ns(struct linux_sys_sched_setaffinity_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_sched_setaffinity },/* 311 = sched_setaffinity */
	{ ns(struct linux_sys_sched_getaffinity_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_sched_getaffinity },/* 312 = sched_getaffinity */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 313 = unimplemented kexec_load */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 314 = unimplemented getcpu */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 315 = unimplemented epoll_wait */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 316 = unimplemented utimensat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 317 = unimplemented signalfd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 318 = unimplemented timerfd_create */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 319 = unimplemented eventfd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 320 = unimplemented fallocate */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 321 = unimplemented timerfd_settime */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 322 = unimplemented timerfd_gettime */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 323 = unimplemented signalfd4 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 324 = unimplemented eventfd2 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 325 = unimplemented epoll_create1 */
	{ ns(struct linux_sys_dup3_args), 0,
	    (sy_call_t *)linux_sys_dup3 },	/* 326 = dup3 */
	{ ns(struct linux_sys_pipe2_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_pipe2 },	/* 327 = pipe2 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 328 = unimplemented inotify_init1 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 329 = unimplemented preadv */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 330 = unimplemented pwritev */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 331 = unimplemented rt_tgsigqueueinfo */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 332 = unimplemented perf_counter_open */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 333 = unimplemented set_thread_area */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 334 = unimplemented get_thread_area */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 335 = unimplemented atomic_cmpxchg_32 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 336 = unimplemented atomic_barrier */
	{ 0, 0, 0,
