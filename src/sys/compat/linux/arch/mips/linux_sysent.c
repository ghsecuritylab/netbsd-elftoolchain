/* linux_sysent.c,v 1.49 2013/04/08 20:58:25 pooka Exp */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "linux_sysent.c,v 1.49 2013/04/08 20:58:25 pooka Exp");
...
struct sysent linux_sysent[] = {
	...
	{ ns(struct linux_sys_cacheflush_args), SYCALL_ARG_PTR,
	...
	{ ns(struct linux_sys_rt_sigtimedwait_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_rt_sigtimedwait },/* 197 = rt_sigtimedwait */
	...
	{ 0, 0, 0,
	    (sy_call_t *)linux_sys_gettid },	/* 222 = gettid */
	{ 0, 0, 0,
	...
	{ ns(struct linux_sys_set_tid_address_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_set_tid_address },/* 252 = set_tid_address */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 253 = unimplemented restart_syscall */
	{ ns(struct linux_sys_fadvise64_args), 0,
	    (sy_call_t *)linux_sys_fadvise64 },	/* 254 = fadvise64 */
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 277 = unimplemented vserve */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 278 = unimplemented waitid */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 279 = unimplemented setaltroot */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 280 = unimplemented add_key */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 281 = unimplemented request_key */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 282 = unimplemented keyctl */
	{ ns(struct linux_sys_set_thread_area_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_set_thread_area },/* 283 = set_thread_area */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 284 = unimplemented inotify_init */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 285 = unimplemented inotify_add_watch */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 286 = unimplemented inotify_rm_watch */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 287 = unimplemented migrate_pages */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 288 = unimplemented openat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 289 = unimplemented mkdirat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 290 = unimplemented mknodat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 291 = unimplemented fchownat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 292 = unimplemented futimesat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 293 = unimplemented fstatat64 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 294 = unimplemented unlinkat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 295 = unimplemented renameat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 296 = unimplemented linkat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 297 = unimplemented symlinkat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 298 = unimplemented readlinkat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 299 = unimplemented fchmodat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 300 = unimplemented faccessat */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 303 = unimplemented unshare */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 304 = unimplemented splice */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 305 = unimplemented sync_file_range */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 306 = unimplemented tee */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 307 = unimplemented vmsplice */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 308 = unimplemented move_pages */
	{ ns(struct linux_sys_set_robust_list_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_set_robust_list },/* 309 = set_robust_list */
	{ ns(struct linux_sys_get_robust_list_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_get_robust_list },/* 310 = get_robust_list */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 311 = unimplemented kexec_load */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 312 = unimplemented getcpu */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 313 = unimplemented epoll_pwait */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 314 = unimplemented ioprio_set */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 315 = unimplemented ioprio_get */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 316 = unimplemented utimensat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 317 = unimplemented signalfd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 318 = unimplemented timerfd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 319 = unimplemented eventfd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 320 = unimplemented fallocate */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 321 = unimplemented timerfd_create */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 322 = unimplemented timerfd_gettime */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 323 = unimplemented timerfd_settime */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 324 = unimplemented signalfd4 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 325 = unimplemented eventfd2 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 326 = unimplemented epoll_create1 */
	{ ns(struct linux_sys_dup3_args), 0,
	    (sy_call_t *)linux_sys_dup3 },	/* 327 = dup3 */
	{ ns(struct linux_sys_pipe2_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_pipe2 },	/* 328 = pipe2 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 329 = unimplemented inotify_init1 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 330 = unimplemented preadv */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 331 = unimplemented pwritev */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 332 = unimplemented rt_tgsigqueueinfo */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 333 = unimplemented perf_event_open */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 334 = unimplemented accept4 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 335 = unimplemented recvmmsg */
	{ 0, 0, 0,
