/* linux_syscall.h,v 1.58 2013/04/08 20:58:26 pooka Exp */
...
/* syscall: "new_select" ret: "int" args: "int" "fd_set *" "fd_set *" "fd_set *" "struct timeval50 *" */
...
#define	LINUX_SYS_rt_sigtimedwait	176
...
#define	LINUX_SYS___posix_chown	181
