/* linux_sysent.c,v 1.58 2013/04/08 20:58:26 pooka Exp */
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "linux_sysent.c,v 1.58 2013/04/08 20:58:26 pooka Exp");
...
struct sysent linux_sysent[] = {
	...
	{ ns(struct linux_sys_rt_sigtimedwait_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_rt_sigtimedwait },/* 176 = rt_sigtimedwait */
...
#define linux_sys_mmap2_args linux_sys_mmap_args
	...
	{ 0, 0, 0,
	    (sy_call_t *)linux_sys_gettid },	/* 207 = gettid */
	{ ns(struct linux_sys_tkill_args), 0,
	    (sy_call_t *)linux_sys_tkill },	/* 208 = tkill */
	...
	{ ns(struct linux_sys_futex_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_futex },	/* 221 = futex */
	{ ns(struct linux_sys_sched_setaffinity_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_sched_setaffinity },/* 222 = sched_setaffinity */
	{ ns(struct linux_sys_sched_getaffinity_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_sched_getaffinity },/* 223 = sched_getaffinity */
	{ 0, 0, 0,
	...
	{ ns(struct linux_sys_set_tid_address_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_set_tid_address },/* 232 = set_tid_address */
	{ ns(struct linux_sys_fadvise64_args), 0,
	    (sy_call_t *)linux_sys_fadvise64 },	/* 233 = fadvise64 */
	...
	{ ns(struct linux_sys_fadvise64_64_args), 0,
	    (sy_call_t *)linux_sys_fadvise64_64 },/* 254 = fadvise64_64 */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 269 = unimplemented add_key */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 270 = unimplemented request_key */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 271 = unimplemented keyctl */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 272 = unimplemented waitid */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 273 = unimplemented ioprio_set */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 274 = unimplemented ioprio_get */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 275 = unimplemented inotify_init */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 276 = unimplemented inotify_add_watch */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 277 = unimplemented inotify_rm_watch */
	{ 0, 0, 0,
	...
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 282 = unimplemented unshare */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 283 = unimplemented splice */
	{ 0, 0, 0,
	...
	{ ns(struct linux_sys_get_robust_list_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_get_robust_list },/* 300 = get_robust_list */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 301 = unimplemented move_pages */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 302 = unimplemented getcpu */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 303 = unimplemented epoll_wait */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 304 = unimplemented utimensat */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 305 = unimplemented signalfd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 306 = unimplemented timerfd_create */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 307 = unimplemented eventfd */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 308 = unimplemented sync_file_range2 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 309 = unimplemented fallocate */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 310 = unimplemented subpage_prot */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 311 = unimplemented timerfd_settime */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 312 = unimplemented timerfd_gettime */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 313 = unimplemented signalfd4 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 314 = unimplemented eventfd2 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 315 = unimplemented epoll_create1 */
	{ ns(struct linux_sys_dup3_args), 0,
	    (sy_call_t *)linux_sys_dup3 },	/* 316 = dup3 */
	{ ns(struct linux_sys_pipe2_args), SYCALL_ARG_PTR,
	    (sy_call_t *)linux_sys_pipe2 },	/* 317 = pipe2 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 318 = unimplemented inotify_init1 */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 319 = unimplemented perf_event_open */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 320 = unimplemented preadv */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 321 = unimplemented pwritev */
	{ 0, 0, 0,
	    linux_sys_nosys },			/* 322 = unimplemented rt_tgsigqueueinfo */
	{ 0, 0, 0,
