/* rump_syscalls.h,v 1.62 2013/03/29 01:51:25 christos Exp */
...
uid_t rump_sys_getuid(void) __RENAME(RUMP_SYS_RENAME_GETUID_WITH_EUID);
...
int rump_sys_mknodat(int, const char *, mode_t, uint32_t) __RENAME(RUMP_SYS_RENAME_MKNODAT);
