/*	fil.c,v 1.8 2013/01/09 13:23:20 christos Exp	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "fil.c,v 1.8 2013/01/09 13:23:20 christos Exp");
#else
...
static	int		ipf_flush_groups(ipf_main_softc_t *, frgroup_t **, int);
...
/* ------------------------------------------------------------------------ */
static frentry_t *
ipf_nextrule(ipf_main_softc_t *softc, int active, int unit,
    frentry_t *fr, int out)
{
	frentry_t *next;
	frgroup_t *fg;
