/*	ip_lookup.c,v 1.3 2012/07/22 14:27:51 darrenr Exp	*/
...
#if defined(__NetBSD__)
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "ip_lookup.c,v 1.3 2012/07/22 14:27:51 darrenr Exp");
#else
 ...
 * [0.POOL_LOOKUP_MAX].
 */
static int ipf_lookup_addnode(ipf_main_softc_t *, void *, int);
static int ipf_lookup_delnode(ipf_main_softc_t *, void *, int);
static int ipf_lookup_addtable(ipf_main_softc_t *, void *);
static int ipf_lookup_deltable(ipf_main_softc_t *, void *);
static int ipf_lookup_stats(ipf_main_softc_t *, void *);
static int ipf_lookup_flush(ipf_main_softc_t *, void *);
