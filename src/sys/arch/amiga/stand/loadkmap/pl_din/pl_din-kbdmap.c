/*	pl_din-kbdmap.c,v 1.1 2002/04/05 00:55:06 heinz Exp	*/

/*
 * Modified for polish keyboard layout (din keyboards) by Pawel Chwalowski
 * <pch@polo.po.opole.pl> 2002-02-25
 */
