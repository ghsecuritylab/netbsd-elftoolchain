/*	ofisa_machdep.c,v 1.10 2012/10/27 17:18:11 chs Exp	*/
...
#include <sys/cdefs.h>
__KERNEL_RCSID(0, "ofisa_machdep.c,v 1.10 2012/10/27 17:18:11 chs Exp");
...
int
ofisa_md_match(device_t parent, cfdata_t cf, void *aux)
{
