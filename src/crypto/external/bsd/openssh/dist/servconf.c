/*	servconf.c,v 1.12 2013/03/29 16:19:45 christos Exp	*/
...
#include "includes.h"
__RCSID("servconf.c,v 1.12 2013/03/29 16:19:45 christos Exp");
#include <sys/types.h>
...
fill_default_server_options(ServerOptions *options)
{
	...
	if (options->pid_file == NULL)
		options->pid_file = __UNCONST(_PATH_SSH_DAEMON_PID_FILE);
